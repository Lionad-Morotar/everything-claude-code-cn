---
name: 安全审查
description: 在添加身份验证、处理用户输入、操作密钥、创建 API 端点或实现支付/敏感功能时使用此技能。提供全面的安全检查清单和模式。
---
...
const dbPassword = "password123" // 存在于源代码中
```
